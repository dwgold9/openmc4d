...
class Halfspace(Region):
    ...
    def motion(self, velocity=None, acceleration=None, inplace=False):
        """Modify the surface referenced by a region to the promoted
        hypersurface generated by a surface moving with an initial velocity and 
        acceleration. 
        ...
        inplace : bool
            ...
            coefficients of this Surface in place. Defaults to False.
        """
        self.surface = self.surface.motion(velocity, acceleration, inplace=inplace)
