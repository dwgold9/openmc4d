...
class Region(ABC):
    ...
    def motion(self, velocity=None, acceleration=None, inplace=True):
        """Recursively modifies all surfaces referenced by a region to the promoted
        ...
        """
        for region in self:
            region.motion(velocity, acceleration, inplace=inplace)  
